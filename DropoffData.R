...
date_time_2013 <- strptime(taxi_2013$`Trip End Timestamp`, format = '%m/%d/%Y %I:%M:%S %p')
date_time_2014 <- strptime(taxi_2014$`Trip End Timestamp`, format = '%m/%d/%Y %I:%M:%S %p')
date_time_2015 <- strptime(taxi_2015$`Trip End Timestamp`, format = '%m/%d/%Y %I:%M:%S %p')
date_time_2016 <- strptime(taxi_2016$`Trip End Timestamp`, format = '%m/%d/%Y %I:%M:%S %p')
date_time_2017 <- strptime(taxi_2017$`Trip End Timestamp`, format = '%m/%d/%Y %I:%M:%S %p')
...
t13 <- taxi_2013[, .(Month = as.numeric(strftime(date_time_2013, '%m')),
                     ...
                     Latitude = `Dropff Centroid Latitude`,
                     Longitude = `Dropff Centroid Longitude`)][, .(Dropffs = .N), by = list(Month, Hour, Day, Latitude, Longitude)]
